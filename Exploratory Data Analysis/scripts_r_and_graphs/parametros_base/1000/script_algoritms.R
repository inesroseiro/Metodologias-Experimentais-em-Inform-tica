...
data
pdf("/Users/iroseiro/Desktop/testes/parametros_base/1000/insertion_1000.pdf")
hist(data,
...
pdf("/Users/iroseiro/Desktop/testes/parametros_base/1000/quick_1000.pdf")
hist(data,
...
data = unlist(df,use.names = FALSE)
data
pdf("/Users/iroseiro/Desktop/testes/parametros_base/1000/merge_1000.pdf")
hist(data,
...
data = unlist(df,use.names = FALSE)
data
pdf("/Users/iroseiro/Desktop/testes/parametros_base/1000/bubble_1000.pdf")
hist(data,
