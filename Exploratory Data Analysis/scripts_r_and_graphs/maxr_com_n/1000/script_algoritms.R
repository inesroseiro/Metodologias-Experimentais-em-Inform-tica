...
pdf("/Users/iroseiro/Desktop/testes/maxr_com_n/1000/insertion_1000.pdf")
hist(data,
...
data = unlist(df,use.names = FALSE)
pdf("/Users/iroseiro/Desktop/testes/maxr_com_n/1000/quick_1000.pdf")
...
pdf("/Users/iroseiro/Desktop/testes/maxr_com_n/1000/merge_1000.pdf")
...
data = unlist(df,use.names = FALSE)
pdf("/Users/iroseiro/Desktop/testes/maxr_com_n/1000/bubble_1000.pdf")
