...
pdf("/Users/iroseiro/Desktop/testes/maxr_com_2n/100/insertion_100.pdf")
hist(data,
...
data = unlist(df,use.names = FALSE)
pdf("/Users/iroseiro/Desktop/testes/maxr_com_2n/100/quick_100.pdf")
...
pdf("/Users/iroseiro/Desktop/testes/maxr_com_2n/100/merge_100.pdf")
...
data = unlist(df,use.names = FALSE)
pdf("/Users/iroseiro/Desktop/testes/maxr_com_2n/100/bubble_100.pdf")
